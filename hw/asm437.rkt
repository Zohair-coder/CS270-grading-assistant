...
(define (orlist L)
  (if (list? L) (foldr ori #f L) #t);Complete this function definition.
)
...
(define (all_q L)
  (if (null? L) #t (if (equal? (first L) 'q) (andi #t (all_q (rest L))) #f)) 
  ;Complete this function definition.
)
...
(define (at_least_one_q L)
  (if (null? L) #f (if (equal? (first L) 'q) (ori #t (at_least_one_q (rest L))) (ori  #f (at_least_one_q (rest L))))) 
  ;Complete this function definition.
;Complete this function definition.
)
...
(define (counter L)
  (if (null? L) 0 (if (equal? (first L) 'q) (+ 1 (counter (rest L))) (counter (rest L) )))

  )
(define (exactly_one_q L)
 (if (equal? (counter L) 1) #t #f)
  ;Complete this function definition.
)
...
(define (odd_amt_q L)
  (if (equal? (remainder (counterx L) 2) 1) #t #f);Complete this function definition.
)
...
(define (odd_amt_q_v2 L)
  (foldr ori #f (map (lambda (x) (if (equal? (remainder (counterx L) 2) 1) #t #f)) L));Complete this function definition.
)
