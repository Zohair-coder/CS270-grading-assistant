...
(define (noti b)
  (if b #f #t);Complete this function definition
 )
...
(define (andi a b)
  (if a (if b #t #f) #f);Complete this function definition.
)
...
(define (ori a b)
  (if a #t(if b #t #f));Complete this function definition.
)
...
(define (xori a b)
  (if a (if b #f #t) (if b #t #f));Complete this function definition.
)
...
(define (impliesi a b)
  (if a (if b #t #f) #t);Complete this function definition.
)
...
(define (iffi a b)
  (if a (if b #t #f) (if b #f #t));Complete this function definition.
)
...
(define (andlist L)
  (foldr andi #t L);Complete this function definition.
)
...
(define (orlist L)
  (foldr ori #f L);Complete this function definition.
)
...
(define (all_q L)
  (if (empty? L) #t (if (equal? 'q (first L)) (all_q (rest L)) #f));Complete this function definition.
)
...
(define (all_q_v2 L)
  (foldr andi #t (map (lambda (x) (if (equal? 'q x) #t #f)) L));Complete this function definition.
)
...
(define (at_least_one_q L)
  (if (empty? L) #f (if (equal? 'q (first L)) #t (at_least_one_q (rest L))));Complete this function definition.
)
...
(define (at_least_one_q_v2 L)
  (foldr ori #f (map (lambda (x) (if (equal? 'q x) #t #f)) L));Complete this function definition.
)
...
(define (exactly_one_q L)
  (if (empty? L) #f (if (equal? 'q (first L)) (if (at_least_one_q (rest L)) #f #t) (if (exactly_one_q (rest L)) #t #f)));Complete this function definition.
)
...
(define (odd_amt_q L)
  (if (null? L) #f (if (equal? 'q (first L)) (if (odd_amt_q (rest L)) #f #t) (if (odd_amt_q (rest L)) #t #f)));Complete this function definition.
)
...
(define (odd_amt_q_v2 L)
  (foldr xori #f (map (lambda (x) (if (equal? 'q x) #t #f)) L));Complete this function definition.
)
